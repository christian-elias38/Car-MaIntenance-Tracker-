...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFF093327);
  static const Color primaryLight = Color(0xFF16A34A);
  static const Color accent = Color(0xFF00C853);
  static const Color mintBackground = Color(0xFFE8F5E9);
  static const Color mintChip = Color(0xFFD1F2D9);

  // Dark Mode Palette
  static const Color darkBackground = Color(0xFF0D1311);
  static const Color darkSurface = Color(0xFF161F1C);
  static const Color darkCard = Color(0xFF1A2622);
